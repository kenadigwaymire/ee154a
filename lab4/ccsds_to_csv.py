"""
-------------------------------------------------------------------------------
Project: Convert CCSDS Binary Data to CSV and Generate Plots

File:    ccsds_to_csv.py

Purpose: Parses and converts CCSDS data files generated by the flight-state-machine.py script into CSV format.
...
Logic:   1. Reads all .ccsds files in the specified data folder.
         ...
         4. Writes the data to a CSV file in the exports folder.
-------------------------------------------------------------------------------
Author:  James Scott
Date:    February 2026
-------------------------------------------------------------------------------
